...
/**
 * DTO de entrada para atualização de um {@link Product}.
 * @param name nome do produto, não deve ser nulo ou vazio.
 * @param description descrição detalhada do produto.
 * @param price preço unitário do produto em reais(BRL), não deve ser nulo ou vazio e deve ser positivo.
 * @param type tipo ou categoria do produto, não deve ser nulo ou vazio.
 * @param code código único do produto, não deve ser nulo ou vazio.
 */
