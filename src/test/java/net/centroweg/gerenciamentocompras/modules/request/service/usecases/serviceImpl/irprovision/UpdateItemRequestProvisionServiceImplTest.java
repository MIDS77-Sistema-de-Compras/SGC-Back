...
class UpdateItemRequestProvisionServiceImplTest {
    ...
    void setUp() {
        service = new UpdateItemRequestProvisionServiceImpl(
                mapper, itemRepository, requestRepository, provisionPublicApi, statusRepository, eventPublisher
        );
        request = new Request();
        request.setId(10L);
    ...
    void shouldNotSaveOrPublishWhenValidationFailsBeforeSave() {
        ...
        when(provisionPublicApi.findById(20L)).thenReturn(Optional.empty());
