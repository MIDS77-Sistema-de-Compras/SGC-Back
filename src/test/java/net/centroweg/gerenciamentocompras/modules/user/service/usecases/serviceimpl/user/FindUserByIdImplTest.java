...
import net.centroweg.gerenciamentocompras.modules.user.service.usecases.serviceImpl.user.FindUserByIdImpl;
...
public class FindUserByIdImplTest {
    ...
    void shouldReturnUserWhenIdExists() {
        Long id = 1L;
        User user = new User();
        UserResponse expectedResponse = new UserResponse(id, "Teste", "000", "e@e.com", "123", true, null, null, "USER", null);
